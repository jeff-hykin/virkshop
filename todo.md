# pre-alpha:
- `1_bare_minimum`
    - change `virkshop_tools` to be a deno executable
    - change system_tools.yaml to force importing specific binaries and ENV vars from packages
    - get devbox working/integrated
